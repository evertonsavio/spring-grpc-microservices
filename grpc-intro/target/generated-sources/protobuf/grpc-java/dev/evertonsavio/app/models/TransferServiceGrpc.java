...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dev.evertonsavio.app.models.TransferRequest,
      dev.evertonsavio.app.models.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = dev.evertonsavio.app.models.TransferRequest.class,
      responseType = dev.evertonsavio.app.models.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<dev.evertonsavio.app.models.TransferRequest,
      dev.evertonsavio.app.models.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<dev.evertonsavio.app.models.TransferRequest, dev.evertonsavio.app.models.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod = 
              io.grpc.MethodDescriptor.<dev.evertonsavio.app.models.TransferRequest, dev.evertonsavio.app.models.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "TransferService", "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.evertonsavio.app.models.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.evertonsavio.app.models.TransferResponse.getDefaultInstance()))
  ...
  public static abstract class TransferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<dev.evertonsavio.app.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<dev.evertonsavio.app.models.TransferResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                dev.evertonsavio.app.models.TransferRequest,
                dev.evertonsavio.app.models.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dev.evertonsavio.app.models.TransferServiceOuterClass.getDescriptor();
    }
